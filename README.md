...
## Setup
To run this website, locally clone the GitHub repository and run the following commands in your terminal
```
...
* Submit form modal.
* Easily add snack to a cart and randomize a selection.
* User able to add own snack. 
* Filter bar that filters by food type. 
